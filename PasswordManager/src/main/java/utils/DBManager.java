...
public class DBManager {
    ...
    public static final String JDBC_URL_MySQL = "jdbc:mysql://localhost:3306/jdbc?user=jdbc&password=123456789&serverTimezone=" + TimeZone.getDefault().getID();

    public static final String JBDC_Driver_MariaDB = "org.mariadb.jdbc.Driver";
    public static final String JDBC_URL_MariaDB = "jdbc:mariadb://localhost:3306/mypasswordmanager?user=luciano&password=L012930&serverTimezone=" + TimeZone.getDefault().getID();
